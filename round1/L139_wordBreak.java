...
public class L139_wordBreak {
    ...
    // T(n): O(n^2)
    // Definition: dp[i] represents if we can form the round1_misc.string, whose index from [0 to i), with words from dict
    ...
    public boolean wordBreakDP(String s, List<String> wordDict) {
        boolean[] dp = new boolean[s.length() + 1];
        dp[s.length()] = true; // empty round1_misc.string  [len , len)
