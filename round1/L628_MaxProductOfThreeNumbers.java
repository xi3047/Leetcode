...
public class L628_MaxProductOfThreeNumbers {
    // Solution 1: using priority queue O(nlog3)
    ...
    // Solution 2: one pass, find three largest numbers and two smallest numbers
